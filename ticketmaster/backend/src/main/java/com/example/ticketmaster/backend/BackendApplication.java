...
public class BackendApplication {
	...
	public CommandLineRunner init(EventRepository eventRepo, UserRepository userRepo){
		return args -> {
		    ...
		    Event event1 = createEvent(eventRepo, "Concert", "2021-02-28T17:00:00.000Z");
            Event event2 = createEvent(eventRepo, "Seminar", "2021-08-04T17:00:00.000Z");
		    User user = createUser(userRepo, event1, "Tauseef", "Kazi", "tkazi827@gmail.com", 27);
		};
	}
    ...
    private ApiInfo apiDetails() {
	    return new ApiInfo(
                ...
                "1.0",
                "Free to use",
                new springfox.documentation.service.Contact("Tauseef Kazi", "https://github.com/tkazi827", "tkazi827@gmail.com"),
                "API License",
                "",
